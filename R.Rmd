...
if(!file.exists("./raw_data/States-Votes.xlsx")) {
  download.file(url = "https://www.fec.gov/documents/1890/federalelections2016.xlsx", destfile = "./raw_data/States-Votes.xlsx", mode = "wb", quiet = TRUE) # Gives corrupted file for some reason, manual download works fine
}
