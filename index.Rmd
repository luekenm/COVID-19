...
ggplot(states) +
  ...
  labs(title = "Percent of Population that is non-White",
       ...
       y = "") +
  coord_map() +
  ggsave("./figures/chorpleth_pop.png")
```

![**Figure 1:** Racial Map of the United States](./figures/chorpleth_pop.png)
...
ggplot(states) +
  ...
  labs(title = "Percent of COVID Deaths from non-White Population",
       ...
       y = "") +
  coord_map() +
  ggsave("./figures/chorpleth_deaths.png")
```

![**Figure 2:** Non-White COVID Deaths as proportion of total COVID Deaths in the United States](./figures/chorpleth_deaths.png)
...
## [The Federal Election Commision](https://www.fec.gov/)

### [Federal Elections 2016](https://www.fec.gov/introduction-campaign-finance/election-and-voting-information/federal-elections-2016/)
...
### [Store Finder](https://www.wholefoodsmarket.com/stores)

## [Southern Poverty Law Center](https://www.splcenter.org/)

### [Whose Heritage?](https://www.splcenter.org/20190201/whose-heritage-public-symbols-confederacy)
