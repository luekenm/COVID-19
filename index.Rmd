...
left_join(prop_other, average_bmi, by = "region") %>%
...
knitr::kable(read_csv("./output/state_health.csv"))
```

\

Words about the horrible data in the BRFSS, sorted by state and given by proportion.

### Graphs and Math with BRFSS

Here go all sorts of comparisons of state-level COVID data with the BRFSS data.
