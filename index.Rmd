...
1. There are differences in health factors and outcomes by racial group

1. Some health factors contribute to COVID deaths

1. There are differences in population density between racial groups
...
ggplot(states) +
  ...
  labs(title = "Percent of Population that is non-White",
       ...
       y = "") +
  coord_map() +
  ggsave("./figures/choropleth_pop.png")
```
...
ggplot(states) +
  ...
  labs(title = "Percent of COVID Deaths from non-White Population",
       ...
       y = "") +
  coord_map() +
  ggsave("./figures/choropleth_deaths.png")
```
